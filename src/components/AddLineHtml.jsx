...
export const AddLineHtml = ({lineObjectHtml}) => {
    const [lineObj,setLineObject]=useState(lineObjectHtml)

    console.warn("buddy",lineObjectHtml)
                        ...
                        <div id={`line-${lineObj.LineNumber}-AnswerCall`} style={{ display: "none" }}>
                            ...
                            <div className="CallUi">
                                ...
                                <div className="answerCall">";
                                    <button onClick={()=>{
                                        console.log("Answering audioa call",lineObj)
                                        AnswerAudioCall(lineObj.LineNumber)}
                                        } className="answerButton"><i className="fa fa-phone"></i> {lang.answer_call}</button>
                                    {EnableVideoCalling}
